...
export const adoptionPostsListSPParsers = {
  // Basic filters
...
export const adoptionPostsListSPCache = createSearchParamsCache(adoptionPostsListSPParsers);

export const paginationSPCache = createSearchParamsCache(paginationParsers);

export const searchParamsCache = createSearchParamsCache({
  ...paginationParsers,
  ...adoptionPostsListSPParsers,
});
